...
/**
 * PROTOTYPE — the floating bar: previous, the current variant's key and name,
 * next. Arrow keys cycle too, unless a field is focused. It rewrites
 ...
 * merge cannot ship the bar. Recovered from the UX lab (`80cb27b`).
 */
