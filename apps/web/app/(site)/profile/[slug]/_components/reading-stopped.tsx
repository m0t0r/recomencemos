 ...
 *
 * **Named for what stopped, not for "paused"** (#265). "Paused" names one thing
 * in this codebase — a Worker's own Pause of her profile — and this component
 * is the Hirer's read ceiling, which has nothing to do with her. The Spanish
 * heading, _Pausamos la lectura de perfiles_, is unchanged: it is Hirer-only and
 * never meets a Worker's own page, so the word there costs nobody a meaning.
 *
...
export function ReadingStopped({ explanation }: { readonly explanation: string }) {
  return (
