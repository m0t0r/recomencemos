...
/**
 * What the live region says when scrolling appends a page.
 *
...
export const LIST_ERROR_TITLE = "No pudimos cargar los perfiles";

/** Says what happened and what to do next, in one breath — and never blames her. */
export const LIST_ERROR_EXPLANATION =
  "Algo falló de nuestro lado al buscar los perfiles. Vuelve a intentarlo.";

export const LIST_ERROR_RETRY = "Volver a intentar";
export const LIST_ERROR_RETRYING = "Cargando…";
