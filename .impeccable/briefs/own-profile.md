...
| [#275](https://github.com/m0t0r/recomencemos/issues/275) | 2026-09-11 | Her whole side on one page — variant A (_Una página_) of the UX lab's idea 7 at `f68ab0f`. **Content and order settled; the phone composition is open** and is the owner's pick from `/prototype` variants on the real route |
...
1. **Where she stands.** One state line — _Visible en el muro desde…_ or _En pausa desde…_ — and the
   Pause switch beside it, with the one sentence naming its two limits. **This is the focal moment.**
...
5. **Who sees what** — #16's three tiers, **kept** `[assumed]`, because they are the page's original
   answer and #275 adds to it. **Where they sit on a phone is a variant axis**, not settled here.
6. Story 11's standing notices at the foot, unchanged.

**Open, for the owner, from variants:** the composition at **390 px first** — how dense section 1 is,
how the card and its photo control sit, whether the Offers summary is rows or a count plus one line,
and whether the three tiers stay open, fold, or step back. Desktop is the adaptation.
...
| visible             | _Visible en el muro desde <fecha>_; the switch reads _Pausar mi perfil_, off                                                                                                                             |
...
| **rate limited**    | The ceiling's own sentence — the count, when she may try again, and that the profile stayed as the state line says — beside the switch, announced                                                        |
...
**Open, and the owner's:** the phone composition, picked from `/prototype` variants on the real route.
