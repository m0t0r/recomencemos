...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Page weight on every route, **measured** and over NFR3's budget        | `apps/web/instrumentation-client.ts` and `apps/web/app/layout.tsx`, and the framework baseline underneath every route                             | Re-measured 2026-09-03 from a production build, gzip on the wire, counting every `<script>` the prerendered document requests and **excluding** the `noModule` polyfill bundle no browser fetches: `/` **292 KB**, `/profiles` **294 KB**, `/privacy` **291 KB**, `/sign-in` **382 KB**, `/publish` **392 KB**. The figures previously recorded here — 297 / 390 / 403 KB, measured on #16 — each counted that polyfill bundle and were about 39 KB high. Attributed on `/`: **Sentry 148 KB**, Base UI 53 KB, framework and app code 81 KB, sonner 10 KB. It is not a `/publish` problem and never was — `/privacy`, a static page owning no client component of its own, is 291 KB — and Sentry is not misconfigured: no Replay, no Feedback, no profiling, `excludeDebugStatements` already on. NFR3 was amended the same day against that measurement, and [#157](https://github.com/m0t0r/recomencemos/issues/157) owns closing the gap by taking Sentry and the `<Toaster />` off the first-load path |
