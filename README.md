...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/publish` page weight, **measured** and over NFR3's budget            | `apps/web/app/(site)/publish/`, and the framework baseline underneath every route                                                                 | Measured on #16 from a production build, cold browser, gzip on the wire: `/` **297 KB** of JavaScript, `/sign-in` **390 KB**, `/publish` **403 KB**, against NFR3's **120 KB**. The publishing form itself costs about 12 KB over `/sign-in`; the rest is the baseline every route pays — React, the Next runtime, the Sentry client SDK and Base UI. [ADR-0014](docs/adr/0014-one-schema-parsed-twice-and-a-form-layer-that-survives-no-javascript.md) said the form layer goes if `/publish` cannot meet the budget, but dropping Zod and TanStack Form from the client would not bring the page within 250 KB of it, so the answer is a spec conversation about the baseline — starting with whether the Sentry client SDK belongs on the Worker path at all — rather than a change to the form. Nobody owns it until that conversation happens |
